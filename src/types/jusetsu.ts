...
export const defaultJusetsuData: JusetsuData = {
  ...
  broker1: {
    ...
    officeAddress: "京都府京都市中京区二条通烏丸東入仁王門町３ 千坂御所南ビル３階",
    phone: "075-600-0170",
    companyName: "（株）MEEM",
    representative: "牧野　連",
  },
  ...
  guaranteeAssociation: {
    name: "公益社団法人　不動産保証協会",
    address: "東京都千代田区紀尾井町3番30号 全日会館",
    localBranch: "公益社団法人 不動産保証協会 京都府本部",
    localBranchAddress: "京都府京都市中京区柳馬場通三条下ル槌屋町98番地2 全日京都会館",
    depositOffice: "東京法務局",
    depositOfficeAddress: "東京都千代田区九段南一丁目1番15号 九段第2合同庁舎",
  },
  building: {
    name: "",
    addressDisplay: "",
